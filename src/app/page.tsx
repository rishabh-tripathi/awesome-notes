      ...
      <div className="relative container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-purple-200 mb-12 max-w-2xl mx-auto leading-relaxed">
            Seamlessly manage your tasks and capture your thoughts in one beautiful, 
            intelligent workspace designed for modern productivity.
          </p>
        ...
        <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/20 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <h4 className="text-xl font-semibold text-white mb-3">Keyboard Shortcuts</h4>
              <p className="text-purple-200 leading-relaxed">
                Master ⌘+N for new items, ⌘+S to save, ⌘+F to search. Work at the speed of thought.
              </p>
            </div>
