...
export default function Login({ onLogin }: LoginProps) {
  ...
  // Static credentials - in production, use proper authentication
  const STATIC_USERNAME = 'rishabh';
  const STATIC_PASSWORD = 'R3s3@rch#Hub2024!';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (username === STATIC_USERNAME && password === STATIC_PASSWORD) {
      localStorage.setItem('research-app-authenticated', 'true');
      onLogin();
    } else {
